export const data = [
  ...
  {
    title: 'Riverdale',
    imgSrc: 'img/Riverdale.jpg',
    genres: ['Drama', 'Criminal', 'Detective'],
    id: 'Riverdale',
    season: '6',
    rating: '9.5',
    description: `This series gives me a lot of mixed emotions. So he sat down to think about the assessment that he should put and came to a standstill. On the one hand, a very interesting series and looks in the same breath until the 6th season, and maybe up to the 5th. Tying mysticism into what is happening and the fact that after the characters grow up they do not change in any way, this is of course such a thing. But the stories in it are catchy, the plot is captivating, and I also feel like Jughead Jones now. In general, I thought it would be a bad rating at a level not higher than 8, but now I understand that it has everything that I love. Firstly, this is the American spirit, and secondly, a very interesting plot and character stories. And it seems like it’s always like this when you watch the series, you get a strange feeling, I personally feel like nostalgia, but I can’t compare it with that. All films released on this site before that were written long or not for very long, but not immediately, unlike this review and written here on emotions. Do I recommend this series? Most likely you will hear yes, after watching several legendary series on this list, I understand that the series is actually top, but I can’t give it a 10 due to the fact that it was over for me on the 6th season and the first 5 episodes , and this series of Rivervale didn’t roll in to me at all, in general, understand what’s going on, but as the further development of events will show, it should be so. So it is necessary that we could understand the essence of the further development of events. I did not think that I would wait for season 7, but yes - I'm waiting for it. And by the way, it should seem to come out in 2022, we are stocking up on food. Probably worth summing up the mess above, I definitely fell in love with the detectives from Riverdale, in the face of the gang of 4 and their friends. Definitely, the plot and the stories of the characters are catchy. A little tricky with magic, of course, but maybe the director has a plan for it, waiting to see it. But still, everything else is top notch, and taking into account that the atmosphere that is shown in the series is definitely something that I adore. Therefore, I advise you to spend your time on this series, and see you in season 7.`,
  },
  {
    ...
    season: '6',
    rating: '10',
    description: `After watching Breaking Bad, I decided to look on YouTube and found a series about Saul that overlapped with Breaking Bad. But the thing is, I had some questionable emotions after Breaking Bad, because it took a very long time to get going and the first two seasons were a heavy burden for me so to speak. Still, after six months and my friend's recommendations, I decided to watch it. The 6 seasons took me about a month and I watched it with more interest than the aforementioned show above. It's pretty cool how the characters from the two shows overlap and their stories unfold, a lot of things that were a mystery after watching Breaking Bad become clear. I would certainly say it's better to watch Saul first and then Heisenberg, but that's debatable. <br>
